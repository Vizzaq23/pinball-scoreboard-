...
try:
    ...
    # Any number of strike plates all wired in parallel to GPIO17 → GND
    targets_any = Button(17, pull_up=True, bounce_time=0.05)  # 50 ms debounce
    USE_GPIO = True
...
if USE_GPIO:
    targets_any.when_pressed = on_target_hit
